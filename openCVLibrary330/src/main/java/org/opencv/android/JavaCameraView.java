    ...
    protected boolean initializeCamera(int width, int height) {
        ...
        synchronized (this) {
            ...
            try {
                ...
                {
                    Log.d(TAG, "Supported Sizes: "+ i.width + " x " +i.height);
                }
                List<Integer> fps1 = params.getSupportedPreviewFrameRates();
                for(Integer i:fps1)
                {
                ...
                if (sizes != null) {
                    ...
                    params.setPreviewSize((int)768,(int) 432);
