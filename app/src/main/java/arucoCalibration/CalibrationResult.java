...
public abstract class CalibrationResult {
    ...
    public static void save(Activity activity, Mat cameraMatrix, Mat distortionCoefficients) {
        ...
        String path = Environment.getExternalStorageDirectory().toString() + "/" + DATA_FILEPATH;
        Log.d(TAG, "Saved params file at " + path);
        File myFile = new File(Environment.getExternalStorageDirectory().toString() + "/" + DATA_FILEPATH);
